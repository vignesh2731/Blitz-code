...
export function SideBar(){
    let sideBarArray=[{name:"Create a Contest",link:"/createContest"},{name:"Join Contest",link:"/joinContest"},{name:"Check Result",link:"/checkResult"},{name:"Report an issue",link:"/issue"},]
    return  <motion.div
